    ...
    for member in members_to_expire:
        ...
        if member.email:
            ...
            message = f"""
                ...
                <p><a href="http://fit.local:8000/app/member-renewal/new?name1={member.name}" style="padding: 10px 15px; background: #dc3545; color: white; text-decoration: none; border-radius: 5px;">Renew Now</a></p>
                <p>Thank you!</p>
            """
            frappe.sendmail(
